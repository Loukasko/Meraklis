            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest()
                        ...
                        @elseif(url()->current()=='http://127.0.0.1:8000/lawbreaker')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('lawbreaker.login') }}">{{ __('Login') }}</a>
                            </li>
                        @elseif(url()->current()=='http://127.0.0.1:8000/manager')
                            <li class="nav-item">
